...
**Generated:** 2026-06-07 06:02 UTC  
...
|---|-----------|--------|----------|
| 1 | test health returns ok | ✅ PASSED | 5.2ms |
| 2 | test categories returns six categories | ✅ PASSED | 4.2ms |
| 3 | test categories has disclaimer | ✅ PASSED | 2.7ms |
| 4 | test disclaimer endpoint | ✅ PASSED | 3.0ms |
| 5 | test order preview returns preview | ✅ PASSED | 3.8ms |
| 6 | test order preview shows paper trade mode | ✅ PASSED | 3.7ms |
| 7 | test order place rejected without confirmation | ✅ PASSED | 3.5ms |
| 8 | test order place accepted with confirmation | ✅ PASSED | 3.3ms |
| 9 | test order place rejected insufficient funds | ✅ PASSED | 3.4ms |
| 10 | test order side validation | ✅ PASSED | 2.5ms |
| 11 | test paper log returns list | ✅ PASSED | 2.9ms |
| 12 | test research returns 200 | ✅ PASSED | 1132.9ms |
| 13 | test research contains disclaimer | ✅ PASSED | 122.7ms |
| 14 | test research invalid ticker in body returns 400 | ✅ PASSED | 52.3ms |
| 15 | test research scores in range | ✅ PASSED | 145.2ms |
| 16 | test research 500 on unexpected error | ✅ PASSED | 5.3ms |
| 17 | test research 400 on value error | ✅ PASSED | 3.2ms |
...
| 2 | test returns unknown on failure | ✅ PASSED | 0.8ms |
| 3 | test record change creates prompt file | ✅ PASSED | 3.0ms |
| 4 | test record change content includes reason | ✅ PASSED | 2.4ms |
| 5 | test record change increments version | ✅ PASSED | 4.9ms |
| 6 | test changelog is updated | ✅ PASSED | 2.5ms |
...
| 9 | test is paper trading by default | ✅ PASSED | 2.6ms |
| 10 | test order rejected without confirmation | ✅ PASSED | 0.6ms |
| 11 | test paper order placed with confirmation | ✅ PASSED | 0.7ms |
| 12 | test insufficient funds rejected | ✅ PASSED | 1.7ms |
| 13 | test paper trade log records order | ✅ PASSED | 0.7ms |
| 14 | test multiple orders in log | ✅ PASSED | 0.8ms |
...
| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test fetch historical prices general exception returns empty | ✅ PASSED | 25.7ms |
| 2 | test fetch nse stock list returns list on success | ✅ PASSED | 1.0ms |
| 3 | test fetch nse stock list returns empty on error | ✅ PASSED | 0.6ms |
...
| 27 | test compute roe normal | ✅ PASSED | 0.2ms |
...
## ✅ General (38/38 passed)

| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test analyze with llm | ✅ PASSED | 28.8ms |
| 2 | test analyze fallback no llm | ✅ PASSED | 0.3ms |
| 3 | test llm failure falls back | ✅ PASSED | 26.2ms |
| 4 | test overall fisher score weights | ✅ PASSED | 0.1ms |
| 5 | test llm json parse error falls back | ✅ PASSED | 26.2ms |
| 6 | test analyze no optional financials | ✅ PASSED | 0.2ms |
| 7 | test analyze with llm no rss | ✅ PASSED | 52.5ms |
| 8 | test analyze fallback no llm | ✅ PASSED | 25.2ms |
| 9 | test rule based bullish | ✅ PASSED | 25.0ms |
| 10 | test rule based bearish | ✅ PASSED | 24.9ms |
| 11 | test rule based hype detection | ✅ PASSED | 24.5ms |
| 12 | test rss fetch network error handled | ✅ PASSED | 24.6ms |
| 13 | test rss fetch filters by ticker | ✅ PASSED | 26.3ms |
| 14 | test rss non 200 skipped | ✅ PASSED | 24.6ms |
| 15 | test analyze with extra articles | ✅ PASSED | 25.9ms |
| 16 | test llm failure falls back | ✅ PASSED | 60.2ms |
| 17 | test close | ✅ PASSED | 25.3ms |
| 18 | test analyze small cap with llm | ✅ PASSED | 71.3ms |
| 19 | test analyze large cap fallback | ✅ PASSED | 0.3ms |
| 20 | test quant filters small cap high growth | ✅ PASSED | 0.1ms |
| 21 | test quant filters large cap no growth | ✅ PASSED | 0.1ms |
| 22 | test sector tailwind defense | ✅ PASSED | 0.1ms |
| 23 | test sector tailwind no match | ✅ PASSED | 0.1ms |
| 24 | test sector tailwind multiple themes | ✅ PASSED | 0.1ms |
| 25 | test overall unicorn score clamps | ✅ PASSED | 0.2ms |
| 26 | test llm failure falls back | ✅ PASSED | 27.1ms |
| 27 | test mid cap label | ✅ PASSED | 0.2ms |
...
| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test fallback score returns all dimensions | ✅ PASSED | 0.7ms |
| 2 | test fallback score is 5 for all | ✅ PASSED | 0.6ms |
| 3 | test overall moat score in range | ✅ PASSED | 0.5ms |
| 4 | test overall moat score max inputs gives near 10 | ✅ PASSED | 0.6ms |
| 5 | test overall moat score min inputs gives 0 | ✅ PASSED | 0.5ms |
| 6 | test analyze without llm uses fallback | ✅ PASSED | 0.7ms |
| 7 | test analyze with llm success | ✅ PASSED | 27.4ms |
| 8 | test analyze with llm fallback on error | ✅ PASSED | 27.5ms |
| 9 | test analyze returns ticker | ✅ PASSED | 0.7ms |
| 10 | test analyze empty articles returns neutral | ✅ PASSED | 0.8ms |
| 11 | test keyword fallback positive sentiment | ✅ PASSED | 0.6ms |
| 12 | test keyword fallback negative sentiment | ✅ PASSED | 0.5ms |
| 13 | test keyword fallback mixed sentiment | ✅ PASSED | 0.6ms |
| 14 | test analyze without llm uses keyword fallback | ✅ PASSED | 0.6ms |
| 15 | test analyze with llm success | ✅ PASSED | 25.9ms |
| 16 | test analyze with llm fallback on error | ✅ PASSED | 26.2ms |
| 17 | test format articles caps at 20 | ✅ PASSED | 0.5ms |

## ✅ News & Sentiment (3/3 passed)

| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test fetch news returns empty when no api key | ✅ PASSED | 26.6ms |
| 2 | test fetch news returns articles on success | ✅ PASSED | 1.0ms |
| 3 | test fetch news returns empty on error | ✅ PASSED | 0.5ms |

## ✅ Portfolio Construction (16/16 passed)

| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test sector weight clamped when sector nearly full | ✅ PASSED | 0.3ms |
| 2 | test weight zero triggers break | ✅ PASSED | 0.2ms |
| 3 | test portfolio suggest endpoint | ✅ PASSED | 3.7ms |
...
## ✅ Research Orchestration (19/19 passed)

| # | Test Case | Status | Duration |
|---|-----------|--------|----------|
| 1 | test growth score between 15 and 20 | ✅ PASSED | 0.1ms |
| 2 | test growth score between 10 and 15 | ✅ PASSED | 0.1ms |
| 3 | test growth score between 5 and 10 | ✅ PASSED | 0.1ms |
| 4 | test growth score none values | ✅ PASSED | 0.1ms |
| 5 | test research returns all required keys | ✅ PASSED | 117.9ms |
| 6 | test disclaimer always present | ✅ PASSED | 106.7ms |
| 7 | test final rating is valid value | ✅ PASSED | 114.2ms |
| 8 | test scores are in range | ✅ PASSED | 155.4ms |
| 9 | test invalid ticker raises | ✅ PASSED | 53.0ms |
| 10 | test growth score high growth | ✅ PASSED | 52.4ms |
| 11 | test growth score low growth | ✅ PASSED | 50.1ms |
| 12 | test rule based synthesis strong candidate | ✅ PASSED | 49.3ms |
| 13 | test llm synthesis with mock | ✅ PASSED | 201.0ms |
| 14 | test llm synthesis falls back on error | ✅ PASSED | 200.8ms |
| 15 | test run single stock | ✅ PASSED | 54.2ms |
| 16 | test run failed stock included as error | ✅ PASSED | 51.9ms |
| 17 | test run multiple stocks | ✅ PASSED | 56.0ms |
| 18 | test report structure | ✅ PASSED | 50.4ms |
| 19 | test top pick structure | ✅ PASSED | 50.2ms |

## ✅ Risk Detection (25/25 passed)
...
| 4 | test rule based synthesis avoid high risk | ✅ PASSED | 49.4ms |
| 5 | test score buffett high risk penalised | ✅ PASSED | 0.1ms |
| 6 | test avoid list excludes strong candidates with low risk | ✅ PASSED | 50.1ms |
...
| 18 | test score pb between 1 5 and 3 | ✅ PASSED | 0.1ms |
...
| 39 | test dcf positive fcf | ✅ PASSED | 0.2ms |
...
| 43 | test analyze returns all keys | ✅ PASSED | 0.2ms |
